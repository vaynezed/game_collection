...
const Chess::ChessPieceType Chess::get_piece_type(const Pos& pos)
{
    return this->chess_board[pos.h_pos][pos.w_pos];
}

void Chess::set_piece_type(const Pos& pos, ChessPieceType piece_type)
{
...
void Chess::render_text()
{
    ...
    const TCHAR* text = this->is_red_player ? TEXT("红方回合"): TEXT("黑方回合");
...
void AIOpponent::make_move(const Pos& from, const Pos& to, Chess::ChessPieceType& captured_piece)
{
...
void AIOpponent::undo_move(const Pos& from, const Pos& to, Chess::ChessPieceType captured_piece)
{
